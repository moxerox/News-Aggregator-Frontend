const FooterComponent = ({...props})=>{
    return (
        <>
        <footer className="footer items-center p-4 bg-base-content text-neutral-content">
            <div className="items-center grid-flow-col">
                ...
                <p>Copyright © 2023 - All right reserved | By <a href="https://linktr.ee/malfaghi" target="_blank" className="underline">Mohamed Alfaghi</a></p>
            </div> 
